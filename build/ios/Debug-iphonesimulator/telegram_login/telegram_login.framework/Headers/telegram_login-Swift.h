...
#ifndef TELEGRAM_LOGIN_SWIFT_H
#define TELEGRAM_LOGIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="telegram_login",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14telegram_login19TelegramLoginPlugin")
@interface TelegramLoginPlugin : NSObject <FlutterPlugin>
...
/// \param registrar The Flutter plugin registrar for registering
...
/// <ul>
///   <li>
///     <code>"configure"</code>: Configures the Telegram SDK with client credentials
///   </li>
///   <li>
///     <code>"login"</code>: Initiates the OAuth login flow
///   </li>
///   <li>
///     <code>"cancelLogin"</code>: Cancels the pending login and rejects the Dart Future
///   </li>
///   <li>
///     <code>"handleUrl"</code>: Forwards a URL to the Telegram SDK for processing
///   </li>
/// </ul>
/// \param call The Flutter method call containing the method name and arguments
///
/// \param result The callback to return results or errors to Dart
///
