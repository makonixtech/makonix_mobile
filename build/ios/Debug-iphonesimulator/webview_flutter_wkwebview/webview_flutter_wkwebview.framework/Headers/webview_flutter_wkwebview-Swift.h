...
+ (WKWebView * _Nullable)webViewForIdentifier:(int64_t)identifier withPluginRegistry:(id <FlutterPluginRegistry> _Nonnull)registry SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("Use webView(forIdentifier:withPluginRegistrar:) instead.");
/// Retrieves the <code>WKWebView</code> that is associated with <code>identifier</code> using a FlutterPluginRegistrar
/// See the Dart method <code>WebKitWebViewController.webViewIdentifier</code> to get the identifier of an
/// underlying <code>WKWebView</code>.
+ (WKWebView * _Nullable)webViewForIdentifier:(int64_t)identifier withPluginRegistrar:(id <FlutterPluginRegistrar> _Nonnull)registrar SWIFT_WARN_UNUSED_RESULT;
